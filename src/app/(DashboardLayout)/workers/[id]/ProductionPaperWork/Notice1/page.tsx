...
const Notice1 = () => {
  return (
    <LegalLetter  title={"Worker Notice"} paragraphs={[
      "As you know we review all persons who work with us using several criteria to determine if they are a good fit for the position that they are assigned to. The criteria are as follows, timelines, quality, customer communication, production, safety and ability to perform the task assigned to them.",
